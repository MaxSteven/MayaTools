...
class IkFkBlending():
    ...
    def generateFKControl(self):
        circle1 = mc.listRelatives(mc.circle( nr=(1, 0, 0), c=(0, 0, 0), r =10)[0], children = True)[0]
        mc.setAttr(circle1+".overrideEnabled", 1)
        mc.setAttr(circle1+".overrideColor", 13)
        circle2 = mc.listRelatives(mc.circle( nr=(0, 1, 0), c=(0, 0, 0), r = 10)[0], children = True)[0]
        mc.setAttr(circle2+".overrideEnabled", 1)
        mc.setAttr(circle2+".overrideColor", 13)
        circle3 = mc.listRelatives(mc.circle( nr=(0, 0, 1), c=(0, 0, 0), r = 10)[0], children = True)[0]
    ...
    def createIKControl(self):
        ...
        self.ikControlObject = mc.circle(nr = (0, 0, 1), c = (0,0,0), r = 2, name = self.jointNames[2]+"_IK_CTL")[0]
    ...
    def blend(self):
        ...
        ikControlPos = mc.xform(self.ikControlObject, query = True, worldSpace = True, translation = True)
