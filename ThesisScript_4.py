...
class WheelAxle():
	def __init__(self, wheelAxleName):
		...
		try:
			mc.file("D:/WheelAxle.ma", ignoreVersion = True, i = True, rpr = wheelAxleName, mergeNamespacesOnClash = True, options = "v=0", type = "mayaAscii", pr = True, ra = True)
		except RuntimeError:
...
class Frame():
	def __init__(self, frameName, frontWheelAxle, backWheelAxle):
		try:
			mc.file("D:/Frame.ma", ignoreVersion = True, i = True, rpr = frameName, mergeNamespacesOnClash = True, options = "v=0", type = "mayaAscii", pr = True, ra = True)
		except RuntimeError:
			print "Runtime Error! Aborting!"
